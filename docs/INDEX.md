...
- [Phase 3B.3 PPTX Options Validation](./PHASE_3B_3_PPTX_OPTIONS_VALIDATION.md): route-level validation for PPTX themes, cover styles, section include flags, and security checks.
