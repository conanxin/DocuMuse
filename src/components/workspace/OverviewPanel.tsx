...
export function OverviewPanel({ analysis }: { analysis?: DocumentAnalysis }) {
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
          ...
          <dl className="mt-4 grid gap-3 text-sm">
            <div className="flex justify-between gap-4">
              ...
              <dd className="font-medium text-slate-900">{overview.docType}</dd>
            </div>
            <div className="flex justify-between gap-4">
              <dt className="text-slate-500">语言</dt>
              <dd className="font-medium text-slate-900">{overview.language}</dd>
            </div>
          </dl>
